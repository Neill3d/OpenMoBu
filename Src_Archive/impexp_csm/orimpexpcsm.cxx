...
{
	FBLibraryRegister( ORMenuItemCSMImport	);
	FBLibraryRegister( ORMenuItemCSMExport	);
}
FBLibraryDeclareEnd;
...
{
	ORMenuItemCSMImport*		lMenuImport = NULL;
	ORMenuItemCSMExport*		lMenuExport = NULL;
	CSMEngine*			lEngine		= new CSMEngine;

	// Menu item activation
	FBMenuItemActivation( ORMenuItemCSMImport );
	FBMenuItemHandle	( ORMenuItemCSMImport, lMenuImport );

	FBMenuItemActivation( ORMenuItemCSMExport );
	FBMenuItemHandle	( ORMenuItemCSMExport, lMenuExport );

	// Both menu items share the same import/export engine.
	lMenuImport->mEngine = lEngine;
	lMenuExport->mEngine = lEngine;
