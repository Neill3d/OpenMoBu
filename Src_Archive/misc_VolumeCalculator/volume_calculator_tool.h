...
class ORToolCustomModel : public FBTool
{
	...
	FBToolDeclare( ORToolCustomModel, FBTool );
  ...
  private:
	...
	void		ConnectionStateNotify		( HISender pSender, HKEvent pEvent );
	void		EventButtonCreateModelClick	( HISender pSender, HKEvent pEvent );
	void		EventButtonCreateModelWithCustomDisplayClick	( HISender pSender, HKEvent pEvent );
...
#endif /* __ORMODEL_TEMPLATE_TOOL_H__ */
