...
constexpr const char* SHADER_LENSFLARE_NAME{ "Lens Flare" };
constexpr const char* SHADER_LENSFLARE_VERTEX{ "\\GLSL\\simple.vsh" };
constexpr const char* SHADER_LENSFLARE_FRAGMENT{ "\\GLSL\\lensFlare.fsh" };
constexpr const char* SHADER_LENSFLARE_BUBBLE_FRAGMENT{ "\\GLSL\\lensFlareBubble.fsh" };
constexpr const char* SHADER_LENSFLARE_ANAMORPHIC_FRAGMENT{ "\\GLSL\\lensFlareAnamorphic.fsh" };
...
bool PostEffectLensFlare::CollectUIValues(UICallback* uiCallback, const SViewInfo& viewInfo)
{
...
bool PostEffectLensFlare::SubShader::CollectUIValues(const int shaderIndex, GLSLShader* mShader, UICallback* uiCallback, const SViewInfo& viewInfo)
{
	m_NumberOfPasses = 1;
	bool lSuccess = false;
