...
constexpr const char* SHADER_DISPLACEMENT_NAME{ "Displacement" };
constexpr const char* SHADER_DISPLACEMENT_VERTEX{ "\\GLSL\\displacement.vsh" };
constexpr const char* SHADER_DISPLACEMENT_FRAGMENT{ "\\GLSL\\displacement.fsh" };
...
bool PostEffectDisplacement::CollectUIValues(UICallback* uiCallback, const SViewInfo& viewInfo)
{
	bool lSuccess = false;
