...
protected:
	...
	public:
		...
		const int GetBufferWidth() const { return bufw; }
		const int GetHeight() const { return height; }
		const int GetBufferHeight() const { return bufh; }
		const double GetScaleFactor() const { return scaleFactor; }
		const int GetNumberOfSamples() const { return depthSamples; }
		const int GetNumberOfCoverageSamples() const { return coverageSamples; }
	};
...
public:
	...
	const GLenum getDepthInternalFormat() const { return depthInternalFormat; }
	const GLenum getDepthFormat() const { return depthFormat; }
	const GLenum getDepthType() const { return depthType; }
	const GLenum getNormalInternalFormat() const { return normalInternalFormat; }
	const GLenum getNormalFormat() const { return normalFormat; }
	const GLenum getNormalType() const { return normalType; }
	const GLenum getMaskInternalFormat() const { return maskInternalFormat; }
	const GLenum getMaskFormat() const { return maskFormat; }
	const GLenum getMaskType() const { return maskType; }
	...
	const int GetWidth() const { return mainInfo.GetWidth(); }
	const int GetHeight() const { return mainInfo.GetHeight(); }
	const int GetBufferWidth() const { return mainInfo.GetBufferWidth(); }
	const int GetBufferHeight() const { return mainInfo.GetBufferHeight(); }
