...
void main()
{
    ...
    atomicAdd(outputNormals.normals[id4].x, n.x);
    atomicAdd(outputNormals.normals[id4].y, n.y);
    atomicAdd(outputNormals.normals[id4].z, n.z);
}