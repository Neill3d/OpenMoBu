...
protected:
	...
	struct RenderData
	{
		...
		std::vector<PostEffectBufferShader*>		mChain; 
...
private:
	...
	bool PrepareChainOrder(std::vector<PostEffectBufferShader*>& chain, StandardEffectCollection* collection);
	...
	/// </summary>
	void MixMasksPass(EffectShaderMix* shader, 
		const int maskindex, 
