...
string(REGEX MATCH "[0-9]+" PRODUCT_VERSION ${productversion})
if (${PRODUCT_VERSION} GREATER 2018)
	...
	set_target_properties(fbxsdk PROPERTIES
		IMPORTED_LOCATION ${MOBU_ROOT}/bin/${BIN_PATH}/fbxsdk${CMAKE_SHARED_LIBRARY_SUFFIX}
	    INTERFACE_INCLUDE_DIRECTORIES ${OPENREALITY_ROOT}/include
	    IMPORTED_IMPLIB ${OPENREALITY_ROOT}/lib/${BIN_PATH}/fbxsdk${CMAKE_STATIC_LIBRARY_SUFFIX}
	)
endif()
